...
public class DelivererPickOrder {
  ...
  @Test
  public void testDelivererPickOrder() throws Exception {
    ...
    driver.findElement(By.name("userPassword")).sendKeys("Srikanth");
    driver.findElement(By.name("userPassword")).clear();
    ...
    driver.findElement(By.name("selectcustomer_order")).click();
    driver.findElement(By.linkText("Selected Orders")).click();
    driver.findElement(By.linkText("Selected Orders")).click();
